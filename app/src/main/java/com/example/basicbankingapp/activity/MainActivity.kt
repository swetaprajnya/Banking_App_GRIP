    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(count>0){
            ...
            val personList = listOf<PersonEntity>(
                    PersonEntity(1, "raj", "adititiwari2311@gmail.com", "8876212345", R.drawable.maleuser, "Male", 10000),
                    PersonEntity(2, "ayush", "UzumakiNaruto@gmail.com", "8856987654", R.drawable.maleuser, "Male", 9000),
                    PersonEntity(3, "rajshree", "UzumakiHinata03@gmail.com", "9422198769", R.drawable.femaleuser, "Female", 8000),
                    PersonEntity(4, "suravi", "sakurauchiha@gmail.com", "7218100620", R.drawable.femaleuser, "Female", 7000),
                    PersonEntity(5, "ram", "sasukeuchiha02@gmail.com", "8856972534", R.drawable.maleuser, "Male", 6000),
                    PersonEntity(6, "raman", "borutouzumaki2001@gmail.com", "8856982369", R.drawable.maleuser, "Male", 5000),
                    PersonEntity(7, "sweta", "uchihasarada29@gmail.com", "8856982369", R.drawable.femaleuser, "Female", 4000),
                    PersonEntity(8, "yani", "bestuchiha@gmail.com", "8856982369", R.drawable.maleuser, "Male", 3000),
                    PersonEntity(9, "Minnie", "minatoNamikaze4@gmail.com", "8856982369", R.drawable.maleuser, "Male", 2000),
                    PersonEntity(10, "sita ", "kushinaUzumaki@gmail.com", "8856982369", R.drawable.femaleuser, "Female", 1000),
            )
